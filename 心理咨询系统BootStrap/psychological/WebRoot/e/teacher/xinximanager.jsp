			    ...
			    $("#btnDelete").click(function(){
			        ...
			        $(".check:checked").each(function(index,domEle){
			             ...
			             $.dialog.confirm("你确定要注销信息?", function(){
				             window.location.href=encodeURI('${pageContext.request.contextPath}/admin/xinximanager.do?pubren=${huiyuan.accountname}&forwardurl=/e/teacher/xinximanager.jsp&actiontype=delete&id='+id);
				          });
			        });
			    });
							...
							<tr>
								<td>资讯标题 <input name="title" value="${title}"
									...
									<input type="hidden" name="actiontype" value="search" />
									   游记分类<span class="search-form-item-content">
...
<%--									<input type="hidden" name="forwardurl" value="/e/huiyuan/xinximanager.jsp" />--%>
									<input type="hidden" name="forwardurl" value="/e/teacher/xinximanager.jsp" />
					...
					<c:forEach var="temxinxi" items="${listxinxi}">
						<tr>
							...
							<td><a class="orange-href"
								href="${pageContext.request.contextPath}/admin/xinximanager.do?actiontype=load&id=${temxinxi.id}&forwardurl=/e/teacher/xinxiadd.jsp&seedid=202">修改</a>
