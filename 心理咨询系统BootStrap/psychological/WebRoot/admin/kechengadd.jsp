...
<body>
	...
	<form name="kechengform" method="post"
		...
		<table class="grid" cellspacing="1" width="100%">
			...
			<input type="hidden" name="forwardurl"
				value="/admin/kechengmanager.do?actiontype=get&forwardurl=/admin/kechengmanager.jsp" />
			<tr>
				<td colspan="4">${errormsg}</td>
			</tr>
			<tr>
				<td width="10%" align="right">名称:</td>
				<td width="*"><input name="mingcheng" placeholder="名称"
					validate="{required:true,messages:{required:'请输入名称'}}"
					value="${requestScope.kecheng.mingcheng}" class="input-txt"
					type="text" id="txtMingcheng" />
				</td>
			</tr>
