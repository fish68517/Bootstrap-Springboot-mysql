			    ...
			    $("#btnDelete").click(function(){
			        ...
			        $(".check:checked").each(function(index,domEle){
			             ...
			             $.dialog.confirm("你确定要注销资讯信息信息?", function(){
				             window.location.href=encodeURI('${pageContext.request.contextPath}/admin/xinximanager.do?actiontype=delete&id='+ id);
						  });
						});
					});
...
<body >
	<div class="search-title">
				...
				<div class="description">
					<a href="${pageContext.request.contextPath}/admin/xinximanager.do?actiontype=load&seedid=202">发布文章
					</a>
				</div>
			</div>
			<!-- 搜索控件开始 -->
					...
					<c:forEach var="temxinxi" items="${listxinxi}">
						<tr>
							...
							<td><a class="edit"
								...
								<a class="chakan" target="_blank" href="${pageContext.request.contextPath}/e/xinxiinfo.jsp?id=${temxinxi.id}">查看</a>
							</td>
						</tr>
					</c:forEach>
				</tbody>
