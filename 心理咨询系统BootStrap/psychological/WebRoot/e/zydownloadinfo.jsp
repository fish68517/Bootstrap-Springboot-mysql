	...
	<div class="fn-clear"></div>
		...
		<div class="info">
			...
			<h5>( 发布人${requestScope.zydownload.pubren} 发布时间:
				${requestScope.zydownload.pubtime})</h5>
			<div class="news-content">
				<table cellpadding="0" cellspacing="1" class="grid" width="100%">
					<tr>
						<td align="right" class="title">标题:</td>
						<td>${requestScope.zydownload.title}</td>

					</tr>

					<tr>
						<td align="right" class="title">资源分类:</td>
						<td>${requestScope.zydownload.fenlei}</td>
					</tr>
