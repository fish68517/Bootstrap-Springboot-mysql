			    ...
			    $("#btnDelete").click(function(){
			        ...
			        $(".check:checked").each(function(index,domEle){
			             ...
			             $.dialog.confirm("你确定要注销下载资源信息?", function(){
				             window.location.href=encodeURI('${pageContext.request.contextPath}/admin/zydownloadmanager.do?actiontype=delete&pubren=${teacher.tno}&forwardurl=/e/teacher/zydownloadmanager.jsp&id='+ id);
						   });
						});
					});
						...
						<c:forEach var="temzydownload" items="${listzydownload}">
							<tr>
								...
								<td><a class="orange-href"
									href="${pageContext.request.contextPath}/admin/zydownloadmanager.do?actiontype=load&id=${temzydownload.id}&forwardurl=/e/teacher/zydownloadadd.jsp">修改</a>
								</td>
							</tr>
						</c:forEach>
					</tbody>
