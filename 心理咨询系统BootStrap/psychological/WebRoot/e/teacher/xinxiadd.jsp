        ...
        <div class="main-content">
            ...
            <form name="xinxiform" method="post"
                ...
                <table class="grid" cellspacing="1" width="100%">
                    ...
                    <input name="pubren" type="hidden" value="${teacher.tno}"/>
                    <input type="hidden" name="errorurl"
                           value="/e/huiyuan/xinxiadd.jsp"/>
                    <input type="hidden" name="forwardurl"
                           value="/admin/xinximanager.do?actiontype=get&pubren=${teacher.tno}&forwardurl=/e/teacher/xinximanager.jsp"/>
                    <tr>
                        <td width="15%" align="right">标题:</td>
                        <td width="35%">
                            <input name="title" validate="{required:true,messages:{required:'请输入内容'}}"
                                   value="${requestScope.xinxi.title}"
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="search-form-item-content">
                                <a textfieldid="hidLanmuname" valuefieldid="hidLanmuid" window_width="800"
                                   window_height="400"
                                   window_title="系统栏目" url="${pageContext.request.contextPath}/admin/lanmuchoose.jsp"
                                   class="ui-open-trigger ui-select-middle-trigger"
                                   href="javascript:void(0)" style="width: 120px;">栏目名称 </a>
                                <input name="lanmuid" validate="{required:true,messages:{required:'请选择栏目'}}"
                                       type="hidden" id="hidLanmuid" runat="server"
                                       value="${requestScope.xinxi.lanmuid}"/>
                                <input name="lanmuming" type="hidden" id="hidLanmuname" runat="server"
                                       value="${requestScope.xinxi.lanmuming}"/>
                            </div>
                        </td>
                    </tr>
